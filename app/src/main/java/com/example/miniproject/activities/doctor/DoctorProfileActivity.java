...
import static com.example.miniproject.manager.Methods.internet;
...
public class DoctorProfileActivity extends AppCompatActivity {
    ...
    Uri uri;
    String doctorName, doctorEmail, mobileNo, dateOfBirth, dbGender, password, doctorUid;
    String uid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog = new CustomProgressDialog(DoctorProfileActivity.this);

        internet();

        Methods.toolbar(DoctorProfileActivity.this, "Edit Profile");
            ...
            reference.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    if (snapshot.exists()) {
                        ...
                        doctorUid = snapshot.child("uid").getValue(String.class);
                        doctorEmail = snapshot.child("doctorEmail").getValue(String.class);
    ...
    private void setListeners() {
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (gender.isEmpty()) {
                    Toast.makeText(DoctorProfileActivity.this, "Please select gender", Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        btnUpdateImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ImagePicker.Companion.with(DoctorProfileActivity.this)
                        .crop(1, 1)
                        .compress(1024)
    ...
    private void updateDataToFirebase(String strUserName, String strMobile, String strDateOfBirth) {
        ...
        updatedData.put("doctorName", strUserName);
        ...
        reference.child(uid).updateChildren(updatedData, new DatabaseReference.CompletionListener() {
            ...
            public void onComplete(@Nullable DatabaseError error, @NonNull DatabaseReference ref) {
                if (error != null) {
                    // Handle the error
                    Toast.makeText(DoctorProfileActivity.this, "Error To Update the data", Toast.LENGTH_SHORT).show();
                } else {
                                        ...
                                        reference.child(uid).updateChildren(updatedData, new DatabaseReference.CompletionListener() {
                                            ...
                                            public void onComplete(@Nullable DatabaseError error, @NonNull DatabaseReference ref) {
                                                if (error != null) {
                                                    ...
                                                    dialog.dismiss();
                                                    isUploaded = false;
                                                    Toast.makeText(DoctorProfileActivity.this, "Profile Updated", Toast.LENGTH_SHORT).show();
                                                }
                                            }
                                        });
    ...
    private void internet() {
        if (!Methods.isNetworkAvailable(DoctorProfileActivity.this)) {
    ...
    private void showNoInternetDialog() {
        ...
        Methods.alertDialog(DoctorProfileActivity.this, R.layout.alert_dialog_no_internet, false, new Methods.DialogListener() {
            @Override
